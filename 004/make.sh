...
compile() {
    ...
    g++ -g -O3 -Werror -std=c++17 -fPIC -o "$output" "$code" $(root-config --cflags --libs) -lTree -lMinuit -lASImage -L/home/motoko/TKI_Comparison/style -lstyle  -I/home/motoko/TKI_Comparison/style
